...
$listTableCells                    <td class="p-4 text-right space-x-2">
            ...
            {% else %}
                <tr>
                    <td colspan="100" class="p-8 text-center text-slate-400">Aucun enregistrement trouvé.</td>
                </tr>
            {% endfor %}
        </tbody>
    </table>
...
echo "\$r->get('/admin/$tableName/{id}/delete', [{$entityName}Controller::class, 'delete']);\n";
